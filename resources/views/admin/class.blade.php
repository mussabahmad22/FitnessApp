                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Delete Class
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <form type="submit" action="{{route('class_delete')}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="intro-y col-span-12 lg:col-span-8 p-5">
                                                        <div class="grid grid-cols-12 gap-4 row-gap-5">
                                                            <input type="hidden" name="delete_class_id"
                                                                id="deleting_id"></input>
                                                            <p>Are you sure! want to Delete Class?</p>
                                                        </div>
                                                    </div>
                                            </div>
